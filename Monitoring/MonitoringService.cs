...
{
    public static readonly ActivitySource ActivitySource = new("dols", "1.0.0");
    ...
    public static IServiceCollection AddTracing(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var serviceName = Assembly.GetEntryAssembly()?.GetName().Name ?? "dols";
        var version = "1.0.0";
            ...
            tracerBuilder
                .SetResourceBuilder(
                    ResourceBuilder.CreateDefault()
                        .AddService(
                configuration["ServiceName"] ?? "dols", serviceVersion: version))
    ...
    public static void SetupTracing(string? zipkinUrl = null)
    {
        ...
        _tracerProvider = Sdk.CreateTracerProviderBuilder()
            .SetResourceBuilder(
                ResourceBuilder.CreateDefault()
                    .AddService(serviceName, "dols", version))
            .AddSource(ActivitySource.Name)
            .AddZipkinExporter(options =>
            {
